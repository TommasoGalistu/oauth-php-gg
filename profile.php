...
<html>
	...
	<body >
        ...
        <div >
            <a href="https://www.linkedin.com/in/tommasogalistu/" class="px-4 py-2 bg-green-500 text-white font-semibold rounded hover:bg-black hover:text-white transition duration-300">Linkedin</a>
            <a href="https://tommasogalistu.com/" class="px-4 py-2 bg-green-500 text-white font-semibold rounded hover:bg-black hover:text-white transition duration-300">Porfolio</a>
            <a href="https://github.com/TommasoGalistu" class="px-4 py-2 bg-green-500 text-white font-semibold rounded hover:bg-black hover:text-white transition duration-300">GitHub</a>
        </div>
